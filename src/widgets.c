...
int l_window_get_child(lua_State *L) {
	GtkWidget **window_ud = lua_touserdata(L, 1);
	GtkWidget *window = *window_ud;

	int child_ref = GPOINTER_TO_INT(g_object_get_data(G_OBJECT(window), "child-ref"));
...
int l_window_set_child(lua_State *L) {
	...
	int child_ref = luaL_ref(L, LUA_REGISTRYINDEX);

	g_object_set_data(G_OBJECT(window), "child-ref", GINT_TO_POINTER(child_ref));
...
static const luaL_Reg l_window_fns[] = {
	{"new", l_window_new},
	{"set_child", l_window_set_child},
	{"present", l_window_present},
	{NULL, NULL}
};
...
static const luaL_Reg l_widget_fns[] = {
	{"get_classes", l_widget_get_classes},
	{"set_classes", l_widget_set_classes},
	{"get_valign", l_widget_get_valign},
	{"set_valign", l_widget_set_valign},
	{"get_halign", l_widget_get_halign},
	{"set_halign", l_widget_set_halign},
	{"get_vexpand", l_widget_get_vexpand},
	{"set_vexpand", l_widget_set_vexpand},
	{"get_hexpand", l_widget_get_hexpand},
	{"set_hexpand", l_widget_set_hexpand},
	{"get_tooltip", l_widget_get_tooltip},
	{"set_tooltip", l_widget_set_tooltip},
	{"get_visible", l_widget_get_visible},
	{"set_visible", l_widget_set_visible},
	{"get_width", l_widget_get_width},
	{"get_height", l_widget_get_height},
...
static const luaL_Reg l_label_fns[] = {
	{"new", l_label_new},
...
int l_helper_set_metatable(lua_State *L) {
...
static const luaL_Reg l_helper_fns[] = {
	{"set_metatable", l_helper_set_metatable},
	{NULL, NULL}
};
...
void widget_fns_register(lua_State *L) {
	...
	luaL_newlib(L, l_widget_fns);
	lua_setfield(L, 1, "widget");

	luaL_newlib(L, l_window_fns);
	lua_setfield(L, 1, "window");

	luaL_newlib(L, l_label_fns);
	lua_setfield(L, 1, "label");
	
	luaL_newlib(L, l_helper_fns);
